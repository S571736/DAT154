...
class Astronomy
{
    public static void Main()
    {
        ...
        DwarfPlanet pluto = new Planet("Pluto", 10, 500, "GREY", 5913520, 90550, Sun);


        Moon moon = new Moon("Moon", 1, 0, "GREY", 384, 27, earth);

        Moon phobis = new Moon("Phobos", 1, 0, "GREY", 9, 0, mars);
        Moon Deimos = new Moon("Deimos", 1, 0, "GREY", 23, 46023, mars);

        Moon metis = new Moon("Metis", 1, 0, "GREY", 128, 0, jupiter);
        Moon adrastea = new Moon("Adrastea", 1, 0, "GREY", 129, 0, jupiter);
        Moon amalthea = new Moon("Amalthea", 1, 0, "GREY", 181, 0, jupiter);
        Moon thebe = new Moon("Thebe", 1, 0, "GREY", 222, 0, jupiter);
        ...
        Moon Ananke = new Moon("Ananke", 1, 0, "GREY", 21200, -631.00, jupiter);
        Moon Carme = new Moon("Carme", 1, 0, "GREY", 22600, -692.00, jupiter);
        Moon Pasiphae = new Moon("Pasiphae", 1, 0, "GREY", 23500, -735.00, jupiter);
        Moon Sinope = new Moon("Sinope", 1, 0, "GREY", 23700, -758.00, jupiter);

        Moon Pan = new Moon("Pan", 1, 0, "GREY", 134, 0, saturn);
        Moon Atlas = new Moon("Atlas", 1, 0, "GREY", 138, 0, saturn);
        Moon Prometheus = new Moon("Prometheus", 1, 0, "GREY", 139, 0, saturn);
        Moon Pandora = new Moon("Pandora", 1, 0, "GREY", 142, 0, saturn);
        Moon Epimetheus = new Moon("Epimetheus", 1, 0, "GREY", 151, 0, saturn);
        Moon Janus = new Moon("Janus", 1, 0, "GREY", 151, 0, saturn);
        Moon Mimas = new Moon("Mimas", 1, 0, "GREY", 186, 0, saturn);
        ...
        Moon Cordelia = new Moon("Cordelia", 1, 0, "GREY", 50, 0, uranus);
        Moon Ophelia = new Moon("Ophelia", 1, 0, "GREY", 54, 0, uranus);
        Moon Bianca = new Moon("Bianca", 1, 0, "GREY", 59, 0, uranus);
        Moon Cressida = new Moon("Cressida", 1, 0, "GREY", 62, 0, uranus);
        Moon Desdemona = new Moon("Desdemona", 1, 0, "GREY", 63, 0, uranus);
        Moon Juliet = new Moon("Juliet", 1, 0, "GREY", 64, 0, uranus);
        Moon Portia = new Moon("Portia", 1, 0, "GREY", 66, 0, uranus);
        Moon Rosalind = new Moon("Rosalind", 1, 0, "GREY", 70, 0, uranus);
        Moon Belinda = new Moon("Belinda", 1, 0, "GREY", 75, 0, uranus);
        Moon Puck = new Moon("Puck", 1, 0, "GREY", 86, 0, uranus);
        ...
        Moon Naiad = new Moon("Naiad", 1, 0, "GREY", 48, 0, neptune);
        Moon Thalassa = new Moon("Thalassa", 1, 0, "GREY", 50, 0, neptune);
        Moon Despina = new Moon("Despina", 1, 0, "GREY", 53, 0, neptune);
        Moon Galatea = new Moon("Galatea", 1, 0, "GREY", 62, 0, neptune);
        Moon Larissa = new Moon("Larissa", 1, 0, "GREY", 74, 0, neptune);
        ...
        Moon Hydra = new Moon("Nereid", 1, 0, "GREY", 65, 38, pluto);
        ...
        foreach (SpaceObject p in allPlanets)
        {
